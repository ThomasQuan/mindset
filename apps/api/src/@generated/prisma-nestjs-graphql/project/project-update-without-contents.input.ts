...
import { TagUpdateManyWithoutProjectsNestedInput } from '../tag/tag-update-many-without-projects-nested.input';

@InputType()
export class ProjectUpdateWithoutContentsInput {
    ...
    @Field(() => TagUpdateManyWithoutProjectsNestedInput, {nullable:true})

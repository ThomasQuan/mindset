...
export class PermissionUncheckedUpdateManyWithoutRolesNestedInput {
    ...
    set?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id' | 'slug'>>;

    @Field(() => [PermissionWhereUniqueInput], {nullable:true})
    @Type(() => PermissionWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id' | 'slug'>>;

    @Field(() => [PermissionWhereUniqueInput], {nullable:true})
    @Type(() => PermissionWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id' | 'slug'>>;

    @Field(() => [PermissionWhereUniqueInput], {nullable:true})
    @Type(() => PermissionWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<PermissionWhereUniqueInput, 'id' | 'slug'>>;

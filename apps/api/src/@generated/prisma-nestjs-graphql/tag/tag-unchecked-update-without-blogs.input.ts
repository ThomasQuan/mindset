...
import { ProjectUncheckedUpdateManyWithoutTagsNestedInput } from '../project/project-unchecked-update-many-without-tags-nested.input';

@InputType()
export class TagUncheckedUpdateWithoutBlogsInput {
    ...
    @Field(() => ProjectUncheckedUpdateManyWithoutTagsNestedInput, {nullable:true})

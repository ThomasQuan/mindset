...
import { BlogCreateNestedManyWithoutAuthorInput } from '../blog/blog-create-nested-many-without-author.input';
...
export class UserCreateWithoutProjectsInput {
    ...
    @Field(() => BlogCreateNestedManyWithoutAuthorInput, {nullable:true})

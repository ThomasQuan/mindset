...
import { NestedEnumBlogStatusWithAggregatesFilter } from './nested-enum-blog-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBlogStatusFilter } from './nested-enum-blog-status-filter.input';

@InputType()
export class EnumBlogStatusWithAggregatesFilter {

...
import { NestedEnumReferenceModelSlugWithAggregatesFilter } from './nested-enum-reference-model-slug-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumReferenceModelSlugFilter } from './nested-enum-reference-model-slug-filter.input';

@InputType()
export class EnumReferenceModelSlugWithAggregatesFilter {

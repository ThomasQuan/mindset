...
import { NestedEnumActionSlugWithAggregatesFilter } from './nested-enum-action-slug-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumActionSlugFilter } from './nested-enum-action-slug-filter.input';

@InputType()
export class EnumActionSlugWithAggregatesFilter {
